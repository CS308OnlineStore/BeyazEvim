    ...
    <div style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <header style={headerStyle}>
        ...
        <div style={navIconsStyle}>
          ...
          <div style={{ marginLeft: '15px', cursor: 'pointer', color: '#333' }}>
      ...
      <nav style={categoryNavStyle}>
        <span style={categoryItemStyle}>Küçük Ev Aletleri</span>
        <span style={categoryItemStyle}>Beyaz Eşya</span>
        <span style={categoryItemStyle}>Elektronik</span>
        <span style={categoryItemStyle}>Isıtma - Soğutma</span>
        <span style={categoryItemStyle}>Kişisel Bakım - Sağlık</span>
      </nav>
